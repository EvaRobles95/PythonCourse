...
# patsy auditory
patsy_aud <- 'response ~ (1|sbj_id)  + (1|block:sbj_id) + target_z + stimulus_z  + stim_1_z + cue_z * PPS_z * block_type_z + resp_1_z * PPS_z * block_type_z'
...
# patsy visual
patsy_vis <- 'response ~ (1|sbj_id)  + (1|Block:sbj_id) + target_z + diff_z  + stim_1_z + cue_z * PPS_z + resp_1_z * PPS_z '
