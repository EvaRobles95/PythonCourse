# -*- coding: utf-8 -*-
"""
Created on Wed Jul 14 14:55:14 2021
...
def run_block(fileName, expInfo, task, coherence_levels):
    ...
    def build_rep_block(block_nr):
        ...
        for d in dirs:
            for c in cohs:
                cuevalid_1[(directions_1==d) & (coherences_1==c)] = np.random.permutation((0,1,1,1))
                cuevalid_2[(directions_2==d) & (coherences_2==c)] = np.random.permutation((0,1,1,1))
    ...
    def build_neut_block(block_nr): 
        ...
        for d in dirs:
            for c in cohs:
                cuevalid_1[(directions_3==d) & (coherences_1==c)] = np.random.permutation((0,1,1,1))
                cuevalid_2[(directions_4==d) & (coherences_2==c)] = np.random.permutation((0,1,1,1))
    ...
    def run_alternate_block(trial_handler_alternate, data_file):
        ...
        try:
            ...
            print('Experiment until now took %0.2f' % (task_clock.getTime()/60.0))
            print('This block took %0.2f minutes' % (block_clock.getTime()/60))
